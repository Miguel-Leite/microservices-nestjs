                ...
                <li >
                  <div className="px-4 py-4 flex items-center sm:px-6">
                    <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                      <div className="truncate">
                        <div className="flex text-sm">
                          <p className="font-medium text-indigo-600 truncate">Curso de ReactJS</p>
                        ...
                        <div className="mt-2 flex">
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            <p>
                              Turma inicia em <time dateTime={dateFormatter.format(new Date())}>
                    ...
                    <div className="ml-5 flex-shrink-0">
                      <Link href={`#`} className="px-2 py-1 border border-transparent text-base font-medium rounded-md text-white bg-violet-600 hover:bg-violet-700">
                          Assistir aulas
                      </Link>
                    </div>
                  </div>
